...
const Header = () => {
  return (
    // THAY ĐỔI:
    // 1. Dùng 'rounded-lg' thay cho 'rounded-t-lg rounded-b-lg' (gọn hơn, bo tròn 4 góc).
    // 2. Dùng 'border-gray-400' để viền xám đậm hơn chút cho dễ nhìn (300 hơi nhạt).
    <header className="w-full h-16 bg-[#ebdcdb] flex items-center justify-between px-6 shadow-sm border border-gray-400 rounded-[5px]">
