      ...
      >
        <CarouselContent>
          {movies.slice(0, 5).map((movie) => (
            <CarouselItem key={movie.id} className="flex justify-center items-center">
              
              {/* Poster Dọc - Nhỏ gọn */}
              <div className="relative w-[300px] h-[450px] rounded-lg shadow-2xl overflow-hidden group select-none">
