...
const MovieCard = ({ movie }) => {
  return (
    <div className="relative group w-[200px] h-[300px] rounded-lg overflow-hidden cursor-pointer flex-shrink-0 transition-transform hover:scale-105 duration-300">
      {/* 1. Ảnh Poster */}
      <img
